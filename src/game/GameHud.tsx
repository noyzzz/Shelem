    ...
    <header className="absolute top-0 left-0 z-40 flex min-h-14 w-full items-center justify-between px-4 py-3 sm:px-6 pointer-events-none">
      ...
      <div className="pointer-events-auto flex items-center gap-2">
        ...
        >
          ...
          >
            <VideoIcon data-icon="inline-start" className="text-primary size-4" />
            <span className="hidden sm:inline font-semibold text-xs">Voice &amp; video</span>
          </PopoverTrigger>
          <PopoverContent align="end" className="w-[min(760px,calc(100vw-24px))] max-h-[80vh] overflow-y-auto p-4 bg-[#081f18]/95 border-white/12 shadow-[0_16px_48px_rgba(0,0,0,0.7)] backdrop-blur-md rounded-xl" keepMounted sideOffset={8}>
            <PopoverHeader className="flex flex-row items-center justify-between pb-3 mb-2 border-b border-white/10">
              <PopoverTitle className="text-sm font-semibold text-foreground">Table conversation</PopoverTitle>
              <Button
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56 rounded-lg border-white/12 bg-[#081f18]/95 shadow-2xl backdrop-blur-md" sideOffset={8}>
            <DropdownMenuGroup>
